 ...
 * @since 1.8
 */
public interface $primitiveFmt$Spliterator {
    /**
     ...
     */
    boolean tryAdvance(Consumer<$primitiveWrp$> action);
     ...
     * @throws NullPointerException if the specified action is null
     */
    default void forEachRemaining(Consumer<$primitiveWrp$> action) {
     ...
     */
    $primitiveFmt$Spliterator trySplit();
     ...
     */
    default Comparator<$primitiveWrp$> getComparator() {
