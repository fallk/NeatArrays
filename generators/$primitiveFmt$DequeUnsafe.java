...
public class $primitiveFmt$DequeUnsafe extends $primitiveFmt$Deque {
     ...
     */
    public $primitiveFmt$DequeUnsafe() {
        super();
    }
     ...
     */
    public $primitiveFmt$DequeUnsafe(int numElements) {
        super(numElements);
    }
     ...
     */
    public $primitiveFmt$DequeUnsafe(Collection<$primitiveWrp$> c) {
        super(c);
    }
