...
import fallk.neatarrays.DoubleIterator;
import fallk.neatarrays.DoubleSpliterator;
...
public class DoubleDeque implements Cloneable, Serializable
{
    ...
    protected static final double NULL_VALUE = Double.MIN_VALUE;
     ...
     */
    public static void shortFill(double[] array) {
    ...
    public boolean contains(double o) {
        ...
        double s = NULL_VALUE;
        for (DoubleIterator it = this.iterator(); it.hasNext(); s = it.next()) {
            if (s == o) {
                return true;
            }
        }
