...
public class HashMap14D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14, V> extends HashMap {
     ...
     */
    public HashMap14D(int initialCapacity) {
     ...
     */
    public HashMap14D(HashMap14D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14, V> cube) {
        super(cube);
    }

    public HashMap14D(int initialCapacity, float loadFactor) {
     ...
     */
    public V get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14) {
     ...
     */
    public V put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14, V value) {
        Map m1 = (Map) super.get(k1);
        if (m1 == null) {
        ...
        return (V) m13.put(k14, value);
    }

    public boolean containsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14) {
        Map m1 = (Map)super.get(k1);
        if (m1 == null) {
            return false;
        }
