...
public class HashMap11D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, V> extends HashMap {
     ...
     */
    public HashMap11D(int initialCapacity) {
     ...
     */
    public HashMap11D(HashMap11D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, V> cube) {
        super(cube);
    }

    public HashMap11D(int initialCapacity, float loadFactor) {
     ...
     */
    public V get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11) {
     ...
     */
    public V put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, V value) {
        Map m1 = (Map) super.get(k1);
        if (m1 == null) {
        ...
        return (V) m10.put(k11, value);
    }

    public boolean containsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11) {
        Map m1 = (Map)super.get(k1);
        if (m1 == null) {
            return false;
        }
    ...
    public boolean containsAnyValue(V value) {
        for (Object m1 : super.values()) {
            for (Object m2 : ((Map) m1).values()) {for (Object m3 : ((Map) m2).values()) {for (Object m4 : ((Map) m3).values()) {for (Object m5 : ((Map) m4).values()) {for (Object m6 : ((Map) m5).values()) {for (Object m7 : ((Map) m6).values()) {for (Object m8 : ((Map) m7).values()) {for (Object m9 : ((Map) m8).values()) {for (Object m10 : ((Map) m9).values()) {
            if (((Map) m10).containsValue(value)) return true;
            }}}}}}}}}
        }
        return false;
    }
