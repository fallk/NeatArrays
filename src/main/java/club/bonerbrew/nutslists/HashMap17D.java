...
public class HashMap17D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14, K15, K16, K17, V> extends HashMap {
     ...
     */
    public HashMap17D(int initialCapacity) {
     ...
     */
    public HashMap17D(HashMap17D<K1, K2, K3, K4, K5, K6, K7, K8, K9, K10, K11, K12, K13, K14, K15, K16, K17, V> cube) {
        super(cube);
    }

    public HashMap17D(int initialCapacity, float loadFactor) {
     ...
     */
    public V get(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14, K15 k15, K16 k16, K17 k17) {
     ...
     */
    public V put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14, K15 k15, K16 k16, K17 k17, V value) {
        Map m1 = (Map) super.get(k1);
        if (m1 == null) {
        ...
        return (V) m16.put(k17, value);
    }

    public boolean containsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, K10 k10, K11 k11, K12 k12, K13 k13, K14 k14, K15 k15, K16 k16, K17 k17) {
        Map m1 = (Map)super.get(k1);
        if (m1 == null) {
            return false;
        }
    ...
    public boolean containsAnyValue(V value) {
        for (Object m1 : super.values()) {
            for (Object m2 : ((Map) m1).values()) {for (Object m3 : ((Map) m2).values()) {for (Object m4 : ((Map) m3).values()) {for (Object m5 : ((Map) m4).values()) {for (Object m6 : ((Map) m5).values()) {for (Object m7 : ((Map) m6).values()) {for (Object m8 : ((Map) m7).values()) {for (Object m9 : ((Map) m8).values()) {for (Object m10 : ((Map) m9).values()) {for (Object m11 : ((Map) m10).values()) {for (Object m12 : ((Map) m11).values()) {for (Object m13 : ((Map) m12).values()) {for (Object m14 : ((Map) m13).values()) {for (Object m15 : ((Map) m14).values()) {for (Object m16 : ((Map) m15).values()) {
            if (((Map) m16).containsValue(value)) return true;
            }}}}}}}}}}}}}}}
        }
        return false;
    }
