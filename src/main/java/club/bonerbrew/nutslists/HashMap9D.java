...
public class HashMap9D<K1, K2, K3, K4, K5, K6, K7, K8, K9, V> extends HashMap {
     ...
     */
    public HashMap9D(int initialCapacity) {
     ...
     */
    public HashMap9D(HashMap9D<K1, K2, K3, K4, K5, K6, K7, K8, K9, V> cube) {
        super(cube);
    }

    public HashMap9D(int initialCapacity, float loadFactor) {
     ...
     */
    public V put(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9, V value) {
        Map m1 = (Map) super.get(k1);
        if (m1 == null) {
        ...
        return (V) m8.put(k9, value);
    }

    public boolean containsKey(K1 k1, K2 k2, K3 k3, K4 k4, K5 k5, K6 k6, K7 k7, K8 k8, K9 k9) {
        Map m1 = (Map)super.get(k1);
        if (m1 == null) {
            return false;
        }
    ...
    public boolean containsAnyValue(V value) {
        for (Object m1 : super.values()) {
            for (Object m2 : ((Map) m1).values()) {for (Object m3 : ((Map) m2).values()) {for (Object m4 : ((Map) m3).values()) {for (Object m5 : ((Map) m4).values()) {for (Object m6 : ((Map) m5).values()) {for (Object m7 : ((Map) m6).values()) {for (Object m8 : ((Map) m7).values()) {
            if (((Map) m8).containsValue(value)) return true;
            }}}}}}}
        }
        return false;
    }
