...
public class LongDeque implements Cloneable, Serializable
{
     ...
     */
    public static void longFill(long[] array) {
    ...
    public long getFirst() {
        long result = (long) elements[head];
        if (result == NULL_VALUE)
            throw new NoSuchElementException();
        return result;
    }
    ...
    public long getLast() {
        ...
        long result = (long) elements[(tail - 1) & (elements.length - 1)];
        if (result == NULL_VALUE)
            throw new NoSuchElementException();
        return result;
    }
    ...
    public long peekFirst() {
        ...
        return (long) elements[head];
    }

    
    public long peekLast() {
        return (long) elements[(tail - 1) & (elements.length - 1)];
    }
    ...
    private class DeqIterator implements LongIterator {
        ...
        public long next() {
            ...
            long result = (long) elements[cursor];
