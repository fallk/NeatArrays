...
import club.bonerbrew.neatarrays.IntIterator;
import club.bonerbrew.neatarrays.IntSpliterator;
...
public class IntDeque implements Cloneable, Serializable
{
     ...
     */
    public static void shortFill(int[] array) {
    ...
    public boolean contains(int o) {
        ...
        int s = NULL_VALUE;
        for (IntIterator it = this.iterator(); it.hasNext(); s = it.next()) {
            if (s == o) {
                return true;
            }
        }
