 ...
 *
 * <p>Most {@code DoubleDeque} operations run in amortized constant time.
 * Exceptions include {@link #remove(double) remove}, {@link
 ...
 * @since   1.6
 * @param <double> the type of elements held in this collection
 */
public class DoubleDeque implements Cloneable, Serializable
{
     ...
     * of the deque (via addLast(double), add(double), or push(double)).
     */
    transient int tail;
     ...
     */
    public static void doubleFill(double[] array) {
     ...
     * @return its argument
     */
    private double[] copyElements(double[] a) {
        if (head < tail) {
     ...
     */
    public DoubleDeque(int numElements) {
     ...
     */
    public DoubleDeque(Collection<Double> c) {
    ...
    public double pollFirst() {
        ...
        double result = (double) elements[h];
    ...
    public double pollLast() {
        ...
        double result = (double) elements[t];
        if (result == NULL_VALUE)
            return NULL_VALUE;
    ...
    public double getFirst() {
        double result = (double) elements[head];
        if (result == NULL_VALUE)
            throw new NoSuchElementException();
        return result;
    }
    ...
    public double getLast() {
        ...
        double result = (double) elements[(tail - 1) & (elements.length - 1)];
        if (result == NULL_VALUE)
            throw new NoSuchElementException();
        return result;
    }
    ...
    public double peekFirst() {
        ...
        return (double) elements[head];
    }

    
    public double peekLast() {
        return (double) elements[(tail - 1) & (elements.length - 1)];
    }
    ...
    private class DeqIterator implements DoubleIterator {
        /**
        ...
        public double next() {
            ...
            double result = (double) elements[cursor];
    ...
    private class DescendingIterator implements DoubleIterator {
        /*
     ...
     *
     * @param o double to be checked for containment in this deque
    ...
    public double[] toArray() {
        return copyElements(new double[size()]);
    }
     ...
     */
    public DoubleDeque clone() {
        try {
            
            DoubleDeque result = (DoubleDeque) super.clone();
    ...
    static final class DeqSpliterator implements DoubleSpliterator {
        private final DoubleDeque deq;
        private int fence;  // -1 until first use
        private int index;  // current index, modified on traverse/split

        /** Creates new spliterator covering the given array and range */
        DeqSpliterator(DoubleDeque deq, int origin, int fence) {
            this.deq = deq;
            this.index = origin;
            this.fence = fence;
        }
        ...
        public void forEachRemaining(Consumer<Double> consumer) {
            if (consumer == null)
                throw new NullPointerException();
            double[] a = deq.elements;
        ...
        public boolean tryAdvance(Consumer<Double> consumer) {
            if (consumer == null)
                throw new NullPointerException();
            double[] a = deq.elements;
            int m = a.length - 1;
