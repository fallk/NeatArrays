 ...
 */
public class ShortDequeUnsafe extends ShortDeque {
     ...
     */
    public ShortDequeUnsafe(int numElements) {
        super(numElements);
    }
     ...
     */
    public ShortDequeUnsafe(Collection<Short> c) {
        super(c);
    }
