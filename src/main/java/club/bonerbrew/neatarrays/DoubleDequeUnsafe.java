 ...
 */
public class DoubleDequeUnsafe extends DoubleDeque {
     ...
     */
    public DoubleDequeUnsafe(int numElements) {
        super(numElements);
    }
     ...
     */
    public DoubleDequeUnsafe(Collection<Double> c) {
        super(c);
    }
